    ...
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('constant.amplitude', rclpy.Parameter.Type.DOUBLE),
                ('constant.frequency', rclpy.Parameter.Type.DOUBLE),
                ('constant.offset', rclpy.Parameter.Type.DOUBLE),
                ('constant.phase', rclpy.Parameter.Type.DOUBLE),
                ('constant.time', rclpy.Parameter.Type.DOUBLE),
            ]
        )
